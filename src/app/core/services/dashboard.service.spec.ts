...
describe('DashboardService', () => {
  ...
  const matchesUrl = `${environment.apiUrl}/api/matches`;
  ...
  it('should load dashboard data with owner and member clubs', () => {
    ...
    httpTesting.expectOne((r) => r.url === matchesUrl && r.params.get('clubId') === 'c1' && r.params.get('size') === '100')
      .flush(emptyPage());
    ...
    httpTesting.expectOne((r) => r.url === matchesUrl && r.params.get('clubId') === 'c1' && r.params.get('size') === '15')
      .flush(emptyPage());
    // recent results for memberClub
    httpTesting.expectOne((r) => r.url === matchesUrl && r.params.get('clubId') === 'c2' && r.params.get('size') === '15')
      .flush(emptyPage());
